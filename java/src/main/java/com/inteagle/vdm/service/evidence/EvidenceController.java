...
@RestController
@RequestMapping("/v1/connections/{c}/devices/{d}/evidence")
public class EvidenceController extends OperationController {
  public EvidenceController(Operations operations, RpcGateway rpc) {
