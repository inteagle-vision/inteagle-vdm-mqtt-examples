...
@RestController
@RequestMapping("/v1/connections/{c}/devices/{d}/alarms")
public class AlarmsController extends OperationController {
  public AlarmsController(Operations operations, RpcGateway rpc) {
