package com.inteagle.vdm.service.device;
...
@RestController
@RequestMapping("/v1/connections/{c}/devices/{d}/device")
public class DeviceController extends OperationController {
  public DeviceController(Operations operations, RpcGateway rpc) {
